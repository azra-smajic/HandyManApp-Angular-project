...
Pomoc.push({
  Naziv:"Dodavanje ponude",
  Oblast: "Ponude",
  Opis: "Ukoliko imate ulogu potražitelja usluga jedna od osnovnih funkcionalnosti jeste dodavanje ponuda. U glavnom meniju se nalazi opcija pod nazivom dodavanje ponude koja vam omogućava tu akciju. Otvaranjem forme za dodavanje ponude kroz tri koraka treba da uneste podatke prema datim naputcima"
...
Pomoc.push({
  Naziv:"Moje ponude",
  Oblast: "Ponude",
  Opis: "Ukoliko imate ulogu potražitelja usluga također imate mogućnost pregleda i uređivanja vlastitih ponuda. Klikom na stavku Moje ponude, koja se nalazi u navigacijskom meniju dobijate prikaz svih ponuda koje ste kreirali. Klikom na dugme uredi, isti možete urediti ili klikom na dugme obriši isti možete obrisati"

})
Pomoc.push({
  Naziv:"Pretraga ponuda",
  Oblast: "Ponude",
...
MojePonude.push({Naziv:"Azra Smajić",
  Grad:"Mostar",
